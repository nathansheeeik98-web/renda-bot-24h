...
echo "🔥 Aplicando ULTRA SEO..."

# -------------------------
# Atualizar worker com Schema + interlink + categorias
# -------------------------
...
pm2 restart renda-bot >/dev/null 2>&1 || true

echo "🔥 ULTRA SEO ATIVADO"
echo "Agora gere 100 páginas:"
echo "curl -X POST http://localhost:3000/admin/generate-bulk?n=100"
